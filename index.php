...
<body style="background: #14192e;" class="p-3">
	...
	<div class="container text-white rounded shadow p-3 my-4" style="background: #232b4a;">
		...
		<div class="container-fluid">
			<h3><i class="fas fa-cogs"></i> CHECKER ALLBINS PRE-AUTH [GATE AMAZON]</h3>
			<span><b>Usuário: <?php echo $username; ?> | Expira em: <?php echo $expira; ?> | Último Login: <?php echo $lastLogin; ?></b></span>
		</div>
		<!-- botoes de ação -->
